<?php $__env->startSection('title', 'Grondstoffen'); ?>
                            ...
                            <td align="right">
                                <div class="input-group">                    
                                    <div class="input-group-btn">
                                        <button class="btn btn-warning btn-xs btn-detail open-modal but-spacing" value="<?php echo e($grondstof->id); ?>"><span class="glyphicon glyphicon-edit"></span>Bewerk</button> 
                                        <button class="btn btn-danger btn-xs btn-delete delete-grondstof but-spacing" value="<?php echo e($grondstof->id); ?>"><span class="glyphicon glyphicon-remove"></span>Verwijder</button>
                                    </div>
                                </div>
                            </td>
                        </tr> 
    ...
    <div class="modal fade bd-example-modal-lg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
                ...
                <?php echo Form::model($grondstoffen, ['files' => false, 'data-parsley-validate' => '', 'id'=>'uploadForm']); ?>   
                        ...
                        <div class="row">
                            <div class="col col-md-12"> 
                                ...
                                <div class="form-group error">
                                    <?php echo e(Form::label('naam', 'Grondstof:', 'class="control-label"')); ?>

                                    <?php echo e(Form::text('naam', null, ["class" => 'form-control', 'required' => '' ])); ?>

                                </div>
                                <div class="form-group">
                                    <?php echo e(Form::label('grondstofcategorie_id', 'Categorie:', 'class="control-label"')); ?>

                                    <?php echo e(Form::select('grondstofcategorie_id', $grondstofcat_dropdown, null, ['class' => 'form-control', 'required' => ''])); ?>
