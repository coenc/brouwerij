                            ...
                            <td align="right">
                                <div class="input-group">                    
                                    <div class="input-group-btn">
                                        <a href= '/grondstoffen/cat/<?php echo e($grondstofcat->id); ?>' title="Toon grondstoffen uit categorie" class="btn btn-info btn-xs but-spacing" role="button"><span class="glyphicon glyphicon-list"></span></a>
    ...
    <div class="modal fade bd-example-modal-lg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <?php echo Form::model($grondstofcats, ['data-parsley-validate' => '', 'id'=>'uploadForm', 'files' => true]); ?>
