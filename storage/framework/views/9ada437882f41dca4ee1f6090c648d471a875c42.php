<?php $__env->startSection('title', 'Producten'); ?>
                            ...
                            <td class="text-right">
                                <div class="input-group">                    
                                    <div class="input-group-btn">
                                        <button class="btn btn-warning btn-xs btn-detail but-spacing open-modal" value="<?php echo e($biersoort->id); ?>"><span class="glyphicon glyphicon-edit"></span><?php echo e(Lang::get('custom.edit')); ?></button> 
                                        <button class="btn btn-danger btn-xs btn-delete but-spacing delete-biersoort" value="<?php echo e($biersoort->id); ?>"><span class="glyphicon glyphicon-remove"></span><?php echo e(Lang::get('custom.delete')); ?></button>
                                    </div>
                                </div>
                            </td>
                        </tr> 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <?php echo Form::model($biersoorten, ['files' => true, 'data-parsley-validate' => '', 'id'=>'uploadForm']); ?> 
                        ...
                        <div class="col col-md-8 col-xs-8">
                            ...
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('vastofseizoen', 'Vast/Seizoen:', 'class="control-label"')); ?>
                        ...
                        <div id="beerdetails" style="display:none;">
                            ...
                            <div class="col col-md-12">
                                ...
                                <div class="form-group error col-md-3 col-sm-3">
                                    ...
                                    <span class="glyphicon glyphicon glyphicon-question-sign tooltip-questionmark" data-toggle="tooltip" title="Graden Plato is het aantal grammen extract per 100 gram wort. Ook wel OG genoemd"></span>
                                    <?php echo e(Form::text('ogmax', null, ["class" => 'form-control'])); ?>
                ...
                <div class="modal-footer">
                    <div class="col col-md-12">
                        <button type="button" class="btn btn-primary" id="btn-cancel"><?php echo e(Lang::get('custom.cancel')); ?></button>
                        <button type="button" class="btn btn-primary" id="btn-save" value="add"><?php echo e(Lang::get('custom.save')); ?></button>
                    </div>
                </div><!-- modal footer -->
    ...
    <script type="text/javascript">
        ...
        $('#biertabel').on('click','.btn-delete', function(){
            ...
            swal({
              ...
              confirmButtonText: '<?php echo e(Lang::get('custom.delete')); ?>',
