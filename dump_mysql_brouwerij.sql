...
INSERT INTO `groups` VALUES (1,'1.jpg','Brouwerij De Vrolijke Gast','Vrolijkstraat 1','1000AA','Amsterdam','info@devrolijkegast.nl',NULL,'2017-04-17 18:17:35'),(2,'2.png','Bakkerij Het Bruine Broodje','Volkorenstraat 123','1234AB','Amsterdam','info@bakkerijhetbruinebroodje.nl',NULL,'2017-04-09 09:33:20');
...
INSERT INTO `visitordata` VALUES (3,'127.0.0.1','http://localhost:8000','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36','2017-04-17 18:06:34','2017-04-17 18:06:34',NULL),(4,'127.0.0.1','http://localhost:8000','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36','2017-04-17 18:07:05','2017-04-17 18:07:05',NULL),(5,'127.0.0.1','http://localhost:8000','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36','2017-04-17 18:07:15','2017-04-17 18:07:15',NULL),(6,'127.0.0.1','http://localhost:8000','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36','2017-04-17 18:17:39','2017-04-17 18:17:39',NULL);
...
--
-- Final view structure for view `vw_inkoop_grondstoffen`
--
...
/*!50001 VIEW `vw_inkoop_grondstoffen` AS select `inkoopgrondstof`.`id` AS `id`,sum(`inkoopgrondstof`.`hoeveelheidkg`) AS `hoeveelheidkg` from `inkoopgrondstof` group by `inkoopgrondstof`.`id` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_verbruik_grondstoffen` AS select `g`.`id` AS `id`,sum((`r`.`hoeveelheid` * `b`.`liters`)) AS `hoeveelheidkg` from (((`brouwsels` `b` join `recepten` `r`) join `beersorts` `bs`) join `grondstoffen` `g`) where ((`b`.`biersoort_id` = `r`.`biersoort_id`) and (`b`.`biersoort_id` = `bs`.`id`) and (`r`.`grondstof_id` = `g`.`id`)) group by `g`.`id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_voorraad_grondstoffen` AS select `g`.`naam` AS `naam`,`i`.`hoeveelheidkg` AS `ingekocht`,`v`.`hoeveelheidkg` AS `verbruikt`,(`i`.`hoeveelheidkg` - `v`.`hoeveelheidkg`) AS `resteert` from ((`vw_verbruik_grondstoffen` `v` join `vw_inkoop_grondstoffen` `i`) join `grondstoffen` `g`) where ((`v`.`id` = `i`.`id`) and (`v`.`id` = `g`.`id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-04-17 20:18:06
